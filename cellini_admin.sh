...
PYTHON="/home/allanberry/webapps/cellini/env/py33/bin/python3.3"

# The path to gunicorn_django
GUNICORN="/home/allanberry/webapps/cellini/env/py33/bin/gunicorn_django"

# The project location, settings.py, urls.py etc....
PROJECTLOC="/home/allanberry/webapps/cellini/cellini_2015/artcase"
